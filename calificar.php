...
if ($result = $conexion->query($query)) {
   ...
   ?>
      ...
      <td><img src="Ver.php?proveedor_id=<?=$id;?>" hight="150" width="150"></td>
      ...
      <td><a href="cal.php?edit_id=<?php echo $id; ?>"><b>Calificar</b></a>|| <a href="editc.php?edit_id=<?php echo $id; ?>"><b>Editar</b></a> </td>
    </tr>
  <?php  }}?>
