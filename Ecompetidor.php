...
<form name="f1" method="post"  enctype="multipart/form-data">
  <table border="1" align="center" rules="groups" height="150%">
    <tr bgcolor="#000000" >
      <th align="left" colspan="2"><h1 style="color:#FFF;padding-left:20px">Editar Perfil:<?php echo $usrm?></h1></th></tr>
...
<tr>
      <td colspan="2" align="left" ><input type="submit" name="actualizar" value="Actualizar" />
                                    <input type="button" value="Cancelar" onclick="window.location='competidor.php';" />
