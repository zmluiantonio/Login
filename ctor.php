...
if(isset($_POST['alta']) && $_POST['alta']=='Dar de Alta')
{
    //echo "hiii";
$necesidad=$_POST["nec"];
$oferta =$_POST["ofe"];
...
<form name="f1" method="post"  enctype="multipart/form-data" >
  <table border="1" align="center" rules="groups" height="80%">
    <tr bgcolor="#000000" >
      <th align="left" colspan="2"><h1 style="color:#FFF;padding-left:20px">Agregar Torneo </h1></th></tr>
...
<tr>
 ...
 <span class="err"><?php echo $error["fi"];?></span></td>
    ...
    <tr>
      <td colspan="2" align="right" ><input type="submit" name="alta" value="Dar de Alta" />
