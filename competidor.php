<?php
  ...
  echo "<script>alert('Debe iniciar Sesion');
    ...
    $usrm=$sesion->get("competidor");}
  
$sel= "SELECT * FROM competidor WHERE usr = '$usrm'";
...
<form name="f1" method="post"  enctype="multipart/form-data">
  <table border="1" align="center" rules="groups" height="150%">
    <tr bgcolor="#000000" >
      <th align="left" colspan="2"><h1 style="color:#FFF;padding-left:20px">Bienvenido:<?php echo $usrm?></h1></th></tr>


    <tr>
<td width="21%"><h5><a href="Ecompetidor.php" style="color:#9A9A9A;">Editar Perfil</a><br>
                <a href="" style="color:#9A9A9A;">Editar Foto de Perfil</a><br>
                <a href="ctorneo.php" style="color:#9A9A9A;">Ver Torneos</a><br>
                 
</td> 
      <td width="21%"><img src="View.php?id=<?=$id;?>" height="150" width="150"><br></td></tr>
...
<tr>
      <td colspan="2" align="center"><a href="cerrar.php" style="color:#000;">Salir</a></td>
    </tr>
